...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1,
        _this = A._asJSObject(A._asJSObject(init.G.document).createElement("input"));
      _this.type = "file";
      _this.accept = "image/*";
      t1 = type$._ElementEventStreamImpl_JSObject;
      A._EventStreamSubscription$(_this, "change", t1._eval$1("~(1)?")._as(new A.main_closure(_this)), false, t1._precomputed1);
    },
  ...
  A.main_closure.prototype = {
    call$1(e) {
      var reader, t1,
        files = A._asJSObjectQ(this.uploadInput.files);
      if (files != null && A._asInt(files.length) > 0) {
        ...
        A._EventStreamSubscription$(reader, "loadend", type$.nullable_void_Function_JSObject._as(new A.main__closure(reader)), false, type$.JSObject);
      }
    },
    $signature: 1
  };
  A.main__closure.prototype = {
    call$1(e) {
      A._asString(this.reader.result);
    },
    $signature: 1
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.main_closure, A.main__closure, A._EventStreamSubscription_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(JSObject)", "~(~())", "Null(@)", "Null()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)"],
